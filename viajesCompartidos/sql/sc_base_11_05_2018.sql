...
insert  into `vehiculo`(`vehiculo_id`,`modelo_id`,`usuario_id`,`cantidad_asientos`,`patente`,`m_baja`,`f_baja`) values (1,5,9,4,'AA',0,'0000-00-00'),(2,14,9,3,'BB',0,NULL),(3,7,9,5,'FF',0,NULL),(4,38,9,1,'GG',0,NULL);
...
insert  into `viaje`(`viaje_id`,`usuario_id`,`vehiculo_id`,`localidad_origen_id`,`localidad_destino_id`,`tipo_viaje_id`,`dia_semana`,`fecha_salida`,`duracion`,`costo`,`m_baja`,`f_baja`) values (1,9,1,1,2,1,1,NULL,30,'159.00',0,NULL),(2,9,2,2,6,2,2,'2018-05-11',15,'1.00',1,'2018-05-11'),(3,9,4,3,6,3,3,'2018-05-12',33,'1.00',0,NULL);
