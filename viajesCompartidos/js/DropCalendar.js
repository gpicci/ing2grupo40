...
var MonthYearColor="#000000"; //"#cc0033";//Font Color of Month and Year in Calendar header.
var WeekHeadColor="#A7C503";//Background Color in Week header.
var SundayColor="#CCFF66";//Background color of Sunday.
var SaturdayColor="#CCFF66";//Background color of Saturday.
var WeekDayColor="#CCFF66";//Background color of weekdays.
var FontColor="#000000";//color of font in Calendar day cell.
var TodayColor="#A7C503";//Background color of today.
var SelDateColor="#A7C503";//Backgrond color of selected date in textbox.
var CalendarBackColor = "#FFFFFF";//Backgrond color of Calendar Window.
var YrSelColor="#000000";//color of font of Year selector.
var NavFontSize="1"; //Font size of line of navigation links.
var CalFontSize="1"; //Font size of line of navigation links.
var vDropCalander="";
...
function RenderCal()
{
 ...
 if( Cal.elem==null)
 {
  try
  {
   Cal.elem = document.createElement('<div id="cal" style="position:absolute; top:'+ bottom + 'px; left:' + leftpos + 'px; z-index:200; width:' + cnWidth + 'px; height:0px;"></div>');
  }
  catch(err)
  {
   ...
   Cal.elem.setAttribute("style","position:absolute; top:"+bottom+"; left:"+leftpos+"; z-index:200; width:" + cnWidth + "px; height:0px;");
  }
 }
 ...
 Cal.elem.style.top = bottom + "px";
 Cal.elem.style.left = leftpos + "px";
...
function FormatDate(pDate)
{
	if (this.Format.toUpperCase()=="DDMMYYYY") {
		...
		return (pDate+DateSeparator+pMonth+DateSeparator+this.Year);
	}
